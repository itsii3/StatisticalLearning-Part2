...
![](Assets/1.2-Ensemble_Methods-Slides_insertimage_3.png)
...
This distribution is usually not known. However, the sampling process and the calculation of the statistics can be approximated using a Monte Carlo Algorithm.
...
knitr::include_graphics("Assets/fromRealWorld2BootstrapWorld.png")
```
...
```{r, fig.align='center', out.width="100%"}
knitr::include_graphics("Assets/oobErrorEstimation.jpg")
```
...
```{r, fig.align='center', out.width="100%"}
knitr::include_graphics("Assets/oobErrorEstimation.png")
```
...
```{r fig.align='center', out.width="100%"}
knitr::include_graphics("Assets/bag_Ames_fit.png")
```
...
```{r}
knitr::include_graphics("Assets/amesVIP2.png")
```
