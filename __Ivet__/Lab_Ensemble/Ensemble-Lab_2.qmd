...
paste("Error train (mse) for bagged tree:", round(train_mse_bag, 2))
```
...
paste("Error test (mse) for bagged tree:", round(test_mse_bag, 2))
```
...
knitr::include_graphics("Assets/baggingRSME.png")
```
